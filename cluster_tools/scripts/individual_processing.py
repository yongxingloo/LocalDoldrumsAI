...
min_length = np.min([len(idx_0), len(idx_1), len(idx_2), len(idx_3), len(idx_4), len(idx_5), len(idx_6), len(idx_7), len(idx_8), len(idx_9), len(idx_10), len(idx_11), len(idx_12), len(idx_13), len(idx_14)])

samples_idx = []
number_of_samples_per_range = len(min_length)
