...
#SBATCH --time=0:20:00        # Request run time (wall-clock). Default is 1 minute
...
#SBATCH --mem-per-cpu=128GB    # Request memory (MB) per node. Default is 1024MB (1GB). For multiple tasks, specify --mem-per-cpu instead
