...
srun python individual_processing_1.py
srun python individual_processing_2.py
srun python individual_processing_3.py
srun python individual_processing_4.py
srun python individual_processing_5.py
srun python individual_processing_6.py